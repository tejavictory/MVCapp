    ...
    public class DbInitializer
    {
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            else
            {
                ...
                {
                    new DegreePlan {DegreePlanId=1, DegreeId =4, StudentId=533568, DegreePlanAbbr="Super Fast", DegreePlanName="Cheetah", DegreePlanSelected=5681},
                    new DegreePlan {DegreePlanId=2, DegreeId =4, StudentId=533568, DegreePlanAbbr="Slow and Easy", DegreePlanName="Tortoise", DegreePlanSelected=5682},
                    new DegreePlan {DegreePlanId=3, DegreeId =4, StudentId=533708, DegreePlanAbbr="Super Fast", DegreePlanName="Cheetah", DegreePlanSelected=7081},
                    new DegreePlan {DegreePlanId=4, DegreeId =4, StudentId=533708, DegreePlanAbbr="Slow and Easy", DegreePlanName="Tortoise", DegreePlanSelected=7082},
                    new DegreePlan {DegreePlanId=5, DegreeId =4, StudentId=533897, DegreePlanAbbr="Super Fast", DegreePlanName="Cheetah", DegreePlanSelected=8971},
                    new DegreePlan {DegreePlanId=6, DegreeId =4, StudentId=533897, DegreePlanAbbr="Summer Off", DegreePlanName="Rabbit", DegreePlanSelected=8973},
